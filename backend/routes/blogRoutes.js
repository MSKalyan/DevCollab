...
import { bodyValidator, validateBlog } from '../middleware/validate.js';
...
router.post('/create', requireAuth, upload.single('image'), bodyValidator(validateBlog), blogController.postCreateBlog);
...
router.delete('/:id', requireAuth, blogController.handleDeleteBlog);
